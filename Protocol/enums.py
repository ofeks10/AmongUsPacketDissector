...
class ChatNoteTypes(enum.IntEnum):
    DIDVOTE = 0


class RPCAction(enum.IntEnum):
    PLAYANIMATION = 0
    COMPLETETASK = 1
    SYNCSETTINGS = 2
    SETINFECTED = 3
...
class RoomMessageType(enum.IntEnum):
    HOST_GAME = 0
    JOIN_GAME = 1
    START_GAME = 2
    REMOVE_GAME = 3
...
class GameDataType(enum.IntEnum):
    DATA = 1
    RPC = 2
    SPAWN = 4
    DESPAWN = 5
